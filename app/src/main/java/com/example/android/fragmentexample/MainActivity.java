...
public class MainActivity<SimpleFragment> extends AppCompatActivity {
    ...
    public void displayFragment() {
        ...
        fragmentTransaction.add(R.id.fragment_container, (Fragment) simpleFragment).addToBackStack(null).commit();
    ...
    public void closeFragment() {
        ...
        if (simpleFragment != null) {
            ...
            fragmentTransaction.remove((Fragment) simpleFragment).commit();
        }
        // Update the Button text.
